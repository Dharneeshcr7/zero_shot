...
from third_party.old_detectron2.detectron2.layers import ShapeSpec, move_device_like
from third_party.old_detectron2.detectron2.structures import Boxes, RotatedBoxes
